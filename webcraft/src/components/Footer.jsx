    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">WebCraft Agency</h3>
            <p className="text-gray-400">Crafting digital experiences that drive results.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <address className="text-gray-400 not-italic">
              <p>Mathabhanga, Coochbehar</p>
              <p>West Bengal, India</p>
              <p>Email: sarkarsubhodeep417@gmail.com</p>
              <p>Phone: +918597722752</p>
            </address>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} WebCraft Agency. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
